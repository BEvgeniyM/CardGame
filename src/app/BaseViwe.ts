...
constructor(private _parent: Container<PIXI.DisplayObject>, private _cardsTexture: Array<string>){
    super();
...
init(cartCount:number = 1): BaseViwe{   
...
onComplete(cart:any){
 ...
 onDragStart(event:any) {
    ...
    // StageController.dragTarget.anchor.set(0.5)
 ...
 onDragEnd(event:any) {    
    if(StageController.dragTarget){
        ...
        if(this._anchorY<= 0.8){           
            ...
            // this._cartPull.x-= this._cartPull.width;            
        ...
        // //@ts-ignore
        // StageController.dragTarget.anchor.set(0.5,this._anchorY);  
        // StageController.dragTarget.angle = angle;
        // StageController.dragTarget.position.set(0+this._pullOfsetX,0);


        // this._cartPull.addChild(StageController.dragTarget);
        // this.removeChild(StageController.dragTarget);
 ...
 resizeCanvas(){
    // let sc = window.outerHeight>window.outerWidth?this._cartPull.height/window.outerHeight:this._cartPull.height/window.outerWidth;
    setTimeout(() => {        
        // this._cartPull.scale.set(sc);
